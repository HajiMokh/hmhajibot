...
----config----
local bot_api_key = "182127188:AAG-Pesve4F3jTZULA4wx_4KXpWMruaNafQ" --BOT TOKEN تو کن ربات خود را در اینجا قرار دهید
...
local oo = io.popen('cd .. ; cd Tarfand ; killall screen ; killall tmux ; killall telegram-cli ; tmux new-session -s script "bash steady.sh -t" ')
		end
	end
